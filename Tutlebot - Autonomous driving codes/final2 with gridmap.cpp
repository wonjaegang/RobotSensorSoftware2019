...
static double destination_x = 5.0, destination_y = 0;//exampsle
...
void msgCALLBACK(const sensor_msgs::LaserScan::ConstPtr& scan)
{
	...
	double g_head = 0.1, g_speed = 0.6, g_clear = 0.4;
...
void odomCALLBACK(const nav_msgs::Odometry::ConstPtr& odom)
{
	...
	//converting from quaternian to thetax = odom->pose.pose.position.x;
